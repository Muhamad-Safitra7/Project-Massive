    ...
    <main id="kelas">
      ...
      <div className="container pt-5 pb-5">
        ...
        >
          ...
          <div style={{ width:"55%",backgroundColor: "#f8f2f2", marginBottom:"20px", borderRadius:"20px" }}>
          <img
          ...
          <Link href={"/profil"} className="btn btn" style={{backgroundColor:"#000000", width:"40%",color:"white", margin:"20px auto"}}>
                  Pay Now
              </Link>
        </div>
      </div>
